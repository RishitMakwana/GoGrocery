    ...
    private void loadProductDetails() {
        ...
        reference.child(firebaseAuth.getUid()).child("products").child(productId)
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    Picasso.get().load(productIcon).placeholder(R.drawable.ic_add_shopping_primary).into(productIconIv);
                }
                catch (Exception e){
                    productIconIv.setBackgroundResource(R.drawable.ic_add_shopping_primary);
                }
            }
